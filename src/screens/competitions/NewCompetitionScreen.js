...
export default function NewCompetitionScreen({navigation: {navigate, setOptions}}){
    ...
    async function newCompetition (title, description, start_time, end_time) {
    ...
    setOptions({
        ...
        event={async() => {
            ...
            await newCompetition(title, description,format(startTime,'yyyy-MM-dd HH:mm:ss'),format(endTime,'yyyy-MM-dd HH:mm:ss'))
