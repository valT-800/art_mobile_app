...
export default function NewCompetitionScreen({navigation: {navigate, setOptions}}){
    ...
    setOptions({
        ...
        event={async() => {
            ...
            await createCompetition(title, description,format(startTime,'yyyy-MM-dd HH:mm:ss'),format(endTime,'yyyy-MM-dd HH:mm:ss'))
    ...
    async function createCompetition (title, description, start_time, end_time) {
        console.log({title, description, start_time, end_time})
        await api.post('api/gallery/competitions', {title, description, start_time, end_time})
        .then((response) => {
