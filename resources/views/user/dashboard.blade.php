...
{{-- šią sekciją galite iškviesti layouts/user.blade.php vaizde su direktyva @yield('title')  --}}
...
{{-- šią sekciją galite iškviesti layouts/user.blade.php vaizde su direktyva @yield('content')  --}}
@section('content')
This is user panel.
@endsection